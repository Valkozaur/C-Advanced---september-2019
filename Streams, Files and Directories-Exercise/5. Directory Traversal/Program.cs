...
namespace StreamsExercise
{
    public class Program
    {
        public static void Main()
        {
            ...
            var files = GetAllFilesFromDirectory(@"C:\Users\valni\OneDrive\Desktop\SoftUni\Repositorys\Advanced-C#-2019\Streams, Files and Directories-Exercise");
            ...
            foreach (var file in files)
            {
                ...
                if (!filesByExtension[extension].ContainsKey(file.Name))
                {
